  ...
  return (
    <div className='flex flex-row bg-black-200 w-full md:w-10/12 xl:w-8/12 h-def mx-auto my-6 justify-center rounded-lg'>
      ...
      <div className='flex flex-col bg-black-100 w-full xl:w-2/3 m-6 rounded-lg'>
        ...
        {showAdd && <div className='mt-10 p-10 self-center flex-col bg-black-200 w-65 rounded-lg xl:hidden z-10 border-solid border-2 absolute'>
        ...
        <button onClick={addButton} class="self-center bg-teal-300 hover:bg-teal-200 text-white font-bold w-3 py-3 px-12 mt-12 mb-12 rounded-full flex justify-center align-middle  xl:hidden ">
          ADD
        </button>
      </div>
